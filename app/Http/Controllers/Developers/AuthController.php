...
class AuthController extends Controller
{
    ...
    public function logout()
    {
    	...
    	return redirect()->route('developer.login')->with('success', 'You have successfully logged out!');
    }
    ...
    public function postForgotPassword(Request $request)
    {
		...
		Mail::send('emails.developer-forgot-password', ["user"=>$user, "code"=>$code] , function($message) use ($user){
    ...
    public function getResetPassword(Request $request)
    {
		...
		{
			return redirect()->route('developer.dashboard')->with('error', 'An unexpected error occurred.');
		}

		$email = $request->email;
		$code  = $request->code;

    	return view('developer.resetPassword', compact('email', 'code'));
    }
