...
class urltopng {
	...
	private $_api_key = "P9CDC38DCFCDD5A";
	private $_secret_key = "S_1D74819348F59";	
	...
	private $_filesave_full = 'asset/captured_webpages/fullsize/'; //for example
	private $_filesave_large = 'asset/captured_webpages/large/';
	private $_filesave_medium = 'asset/captured_webpages/medium/';
	private $_filesave_small = 'asset/captured_webpages/small/';
	private $_filesave_mobile = 'asset/captured_webpages/mobile/';
...
/* 		$file_save_location = $this->_filesave_loc . $this->_pub_key . '.png'; */
	...
	file_put_contents(public_path('/') . $file_save_location, $img);
	return $file_save_location;
	} else {
...
private function _url2png_v6() {
  ...
  $TOKEN = md5($query_string . $URL2PNG_SECRET);
	...
	//die("http://beta.url2png.com/v6/$URL2PNG_APIKEY/$TOKEN/png/?$query_string");
