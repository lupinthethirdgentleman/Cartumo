@if ( !empty($data['product_id']) )
    <div class="ld-element ui-draggable order-bump-wrapper ld-editable inline-element" id="{{ $id }}"
        ...
        <div class="element-bump-info lh4 size3 ld-margin0 element-text-shadow padd-15"
             style="border-color:#000000;background-color:#fcf8e3">
                ...
                <div class="order-for-bump border-dashed-black product-item product-bump-switch">
                    <ul style="background-color:#ffff99">
                        ...
                        <li><input type="checkbox" class="checkbox" name="bump[product_id]"
                                   ...
                                   data-product-type="{{ $data['product_type'] = $data['product_type'] }}"/></li>
                        <li style="font-size: 21px;color:#009900"><b>5Yes, I will Take It!!!!!!!</b></li>
                    </ul>
            ...
            <div class="wrapper ld_editable">
                <div class="order-for-bump border-dashed-black product-item product-bump-switch">
                    <ul style="background-color:#ffff99">
                        ...
                        @else
                            <li><input type="checkbox" class="checkbox" name="bump[product_id]" value="11"
                                       id="bump_product_offer" data-product-type="{{ $data['product_type'] }}"/></li>
                        @endif
                        <li style="font-size: 21px;color:#009900"><b>61Yes, I will Take It!</b></li>
                    </ul>
            ...
            <div class="wrapper ld_editable">
                <div class="order-for-bump border-dashed-black product-item product-bump-switch">
                    <ul style="background-color:#ffff99">
                        ...
                        <li style="font-size: 21px;color:#009900"><b>7Yes, I will Take It!</b></li>
                    </ul>
