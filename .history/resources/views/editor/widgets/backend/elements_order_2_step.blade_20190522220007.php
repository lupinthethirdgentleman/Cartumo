                                        ...
                                        @if ( !empty($data['product_id']) )
                                            <div class="order-for-bump border-dashed-black product-item product-bump-switch">
                                                <ul style="background-color:#ffff99">
                                                    ...
                                                    <li style="font-size: 21px;color:#009900"><b>8Yes, I will Take
                                                            It!</b></li>
                                                </ul>
                                        ...
                                        @elseif ( !empty($data['bumpProduct']) )
                                            <div class="order-for-bump border-dashed-black product-item product-bump-switch">
                                                <ul style="background-color:#ffff99">
                                                    ...
                                                    @endif
                                                    <li style="font-size: 21px;color:#009900"><b>9Yes, I will Take
                                                            It!</b></li>
                                                </ul>
                                        ...
                                        @else
                                            <div class="order-for-bump border-dashed-black product-item product-bump-switch">
                                                <ul style="background-color:#ffff99">
                                                    ...
                                                    <li style="font-size: 21px;color:#009900"><b>10Yes, I will Take
                                                            It!</b></li>
                                                </ul>
