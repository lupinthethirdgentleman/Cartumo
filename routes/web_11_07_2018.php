...
Route::prefix('admin')->group(function() {
    ...
    //HELP CENTER
    Route::resource('/help-center/categories', 'admin\HelpCenterCategoryController', ['as' => 'admin']);
...
//Route::get('/developer', 'developer\DeveloperLoginController@showLoginForm')->name('developer.start');    
Route::group(['prefix' => 'developer'], function() {

    //Route::get('/', 'admin\AdminLoginController@index');
    //Route::post('/', 'admin\AdminLoginController@login')->name('admin');

    //Route::get('/', 'developer\DeveloperLoginController@showLoginForm')->name('developer.start');
    Route::get('/login', 'developer\DeveloperLoginController@showLoginForm')->name('developer.login');
    Route::post('/login', 'developer\DeveloperLoginController@login')->name('developer.login.submit');
    Route::get('/logout', 'developer\DeveloperLoginController@logout')->name('developer.logout');

    //TEMAPLATE
    Route::resource('/templates', 'developer\TemplateController', ['as' => 'developer']);
    Route::get('/templates/{id}/design/', 'developer\TemplateController@design')->name('developer.template.design');
    Route::get('/templates/{id}/clear', 'developer\TemplateController@clearTemplate')->name('developer.template.clear');
    Route::post('/templates/{id}/design/update', 'developer\TemplateController@designUpdate')->name('developer.template.design.update');


    //Widgets
    Route::post('widget/element/screenshoot', 'developer\WidgetController@getscreenshoot');
    Route::get('widget/element/{id}', 'developer\WidgetController@getElement');
    //Route::get('widget/settings/{id}', 'ElementSettingsController@getElementSettings');
    //Route::post('widget/settings/{id}', 'ElementSettingsController@getElementSettings');
    Route::resource('widget', 'developer\WidgetController', ['as' => 'developer']);

    //Image
    Route::get('ajaxImageUpload', ['uses'=>'developer\WidgetController@ajaxImageUpload']);
    Route::post('ajaxImageUpload', 'developer\WidgetController@ajaxImageUploadPost')->name('ajaxImageUpload');
    Route::get('/gallery-images', 'developer\WidgetController@getGalleryImages')->name('gallery.images.list'); //gallery.images.get
    Route::post('/gallery-images', 'developer\WidgetController@getUserGalleryImages')->name('gallery.images.get');
    Route::post('/gallery-images/remove', 'developer\WidgetController@removeGalleryImages')->name('gallery.image.remove');


    Route::get('/dashboard', 'developer\DeveloperController@index')->name('developer.dashboard');
