                    ...
                    <div class="text-center" style="padding: 15px; width: 80%">
                        <ul class="navbar-buttons editor-navbar-buttons" style="margin-bottom: 0px;">
                            <li class="pull-left editor-nav-menu-left">
                                <ul>
                                    <li>
                                        <button class="btn btn-success builderpagetemplate" id="button_editor_save"><i
                            ...
                            <div role="tabpanel" class="tab-pane fade active in" id="button_tab_settings"
                                ...
                                <div class="" id="button_settings_goto_link" style="display: none">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input onkeyup="validate();" type="text" class="form-control" id="button_setting_goto_link_url"
...
<script>
	...
	function validate() 
	{
        ...
        var url = document.getElementById("button_setting_goto_link_url").value;
        var pattern = /(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?/;
        if (pattern.test(url)) {
           // document.getElementById("button_setting_goto_link_url").append("Url is valid");
		   alert("Url is valid");
