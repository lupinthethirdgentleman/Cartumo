                    ...
                    <div class="panels">
                        <div class="form-group">
                            ...
                            <label for="selection_payment_paypal">
                                <input type="radio" id="selection_payment_paypal" name="payment_selection" class="panel-selection-radio"
                                       value="paypal" required />
                                <img src="{{ asset('images/paypalac1.png') }}" style="width: 30%" />
                            </label>
                        </div>

                        <div class="body" style="display: none;">
                            <img src="{{ asset('frontend/images/redirect.png') }}" />
                            <p>After clicking "Complete Order", you will be redirect to PayPal to complete your purchase securely.</p>
                        </div>
                    </div>
