            ...
            <div class="wrapper">
                ...
                <div class="two-step-form">
                    <div class="step-header">
                        <ul>
                            <li class="active"><strong>SHIPPING</strong>
                                <p>Where To Ship Book</p></li>
                            <li><strong>YOUR INFO</strong>
                                <p>Your Billing Info</p></li>
                        </ul>
                    </div>
                    ...
                    <div class="step-body">
                        ...
                        <div class="step-section">
                            ...
                            <!--<div class="row">
                                    <div class="col-md-12">
                                        <table class="table table-bordered dynamic-product-selection-table">
                                            <thead>
                                                <tr>
                                                    <th>Item</th>
                                                    <th>Price</th>
