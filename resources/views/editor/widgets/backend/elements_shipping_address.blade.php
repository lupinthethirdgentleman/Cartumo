    ...
    <div class="ld-element ld-element-form shipping-form-wrapper inline-element" id="{{ $id }}"
         data-de-type="shipping-form">
        <div class="element-shipping-form lh4 size3 ld-margin0 element-text-shadow">
            <div class="wrapper">
                    ...
                    <div class="form-group">
                        <div class="row clearfix">
                            <div class="col-md-8">
                                ...
                                <input type="text" name="full_address" class="form-control" placeholder="Address" required />                                
                            </div>
        ...
        <div class="ld_inline_controls">
            <ul class="ld_option_menu">
                ...
                <li class="ld_controls_edit open-shipping-addresssetings-modal" data-toggle="modal" data-target="#shippingAddressSettingsModal">
