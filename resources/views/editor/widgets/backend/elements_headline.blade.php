<div class="ld-element element-layout headline-wrapper ld-editable inline-element" id="{{ $id }}" data-de-type="headline">
        <div class="element-headline lh4 size3 ld-margin0 element-text-shadow">
            <div class="wrapper ld_editable" style="margin-top:0px;margin-bottom:0px;margin-right:0px;margin-left:0px">
                <b class="ld-editable-element" data-align="" style="padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px;font-size:32px;display:block;font-family:Nunito">Large Call to Action Headline</b>
            </div>
        </div>
