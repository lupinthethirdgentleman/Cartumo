    ...
    <div class="ld-element ld-element-form headline-wrapper ld-editable inline-element" id="{{ $id }}"
        ...
        <div class="ld_inline_controls">
            <ul class="ld_option_menu">
                ...
                <li class="ld_controls_edit open-shipping-addresssetings-modal" data-toggle="modal"
                    data-target="#shippingAddressSettingsModal"><i class="fa fa-cog" aria-hidden="true"></i></li>
