    ...
    <div class="ld-element ld-element-form billing-form-wrapper inline-element" id="{{ $id }}"
         data-de-type="billing-form">
        <div class="element-billing-form lh4 size3 ld-margin0 element-text-shadow">
            <div class="wrapper">

                <div class="form-address-selection-panel billing-form">
        ...
        <div class="ld_inline_controls">
            <ul class="ld_option_menu">
                ...
                <li class="ld_controls_edit open-billing-address-setings-modal" data-toggle="modal" data-target="#billingAddressSettingsModal">
