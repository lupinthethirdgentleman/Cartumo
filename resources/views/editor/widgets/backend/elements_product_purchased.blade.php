    ...
    <div class="ld-element ld-dynamic-update headline-wrapper ld-editable inline-element" id="{{ $id }}"
         data-de-type="product-purchased">
        <div class="element-headline lh4 size3 ld-margin0 element-text-shadow">
            <div class="wrapper">
                <table class="table table-bordered dynamic-product-purchased-table">
                    <thead>
                    <tr>
                        <th>Item</th>
                        <th>Price</th>
