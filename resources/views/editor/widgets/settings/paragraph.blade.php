        ...
        <div role="tabpanel" class="tab-pane fade active in" id="tab_settings" aria-labelledby="home-tab">
            ...
            <form id="frm_paragraph_settings" class="form-horizontal">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-3" for="paragraph_text">Paragraph Text:</label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="paragraph_text" name="paragraph_text" placeholder="Enter headline text" value="{{ $settings->paragraph_text }}" />
                    </div>
                </div>
