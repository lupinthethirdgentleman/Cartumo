...
@section('content')
    ...
    <div class="right_col" role="main">
        ...
        <div class="row clearfix">
            ...
            <div class="x_panel">
                <div class="x_content">
                    {!! Form::open(array('route' => 'smtp.store', 'data-parsley-required' => '', 'class' => 'form-horizontal form-label-left input_mask', 'id' => 'frm_smtp_settings')) !!}
                    ...
                    <div class="row clearfix">
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                            ...
                            {{ Form::text('from_name', null, array('class' => 'form-control has-feedback-left', 'required' => '', 'maxlength' => 255, 'placeholder' => 'From Name')) }}
                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                            ...
                            {{ Form::text('from_mail', null, array('class' => 'form-control has-feedback-right', 'required' => '', 'maxlength' => 255, 'placeholder' => 'From Email')) }}
                    ...
                    <div class="row clearfix">
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                            ...
                            {{ Form::text('smtp_server', null, array('class' => 'form-control has-feedback-left', 'required' => '', 'maxlength' => 255, 'placeholder' => 'SMTP Server')) }}
                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                        </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                            ...
                            {{ Form::text('smtp_user', null, array('class' => 'form-control has-feedback-left', 'required' => '', 'maxlength' => 255, 'placeholder' => 'SMTP User')) }}
                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                        </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                            ...
                            {{ Form::text('smtp_domain', null, array('class' => 'form-control has-feedback-left', 'required' => '', 'maxlength' => 255, 'placeholder' => 'SMTP Domain')) }}
                            <span class="fa fa-user form-control-feedback left" aria-hidden="true"></span>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                            {{ Form::label('smtp_status', 'Status:') }}
                            {{ Form::select('smtp_status', [1=>'Enabled', 0=>'Disabled'], null, array('class' => 'form-control', 'required' => '', 'maxlength' => 255, 'placeholder' => 'SMTP Status')) }}
                        </div>
                    </div>
