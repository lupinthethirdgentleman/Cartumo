                                ...
                                <tbody>
                                    @foreach($blogs as $blog)
                                        <tr>
                                            ...
                                            <td>
                                                <a title="View" href="{{ route('admin.blogs.show', [$blog->id]) }}">
                                                    {{ $blog->title }}
                                                </a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <label title="Change Status" class="switch">
                                                    <input type="checkbox" name="checkbox" {{ ($blog->status==1) ? 'checked' : '' }}>
                                                    <div class="slider round switch-status" blog-id="{{ $blog->id }}"></div>
                                                </label>

                                                <a title="Edit" class="btn btn-success btn-xs" href="{{ route('admin.blogs.edit', [$blog->id]) }}"><i class="fa fa-pencil"></i></a>
                                                
                                                <a title="Delete" href="{{ route('admin.blogs.destroy', [$blog->id]) }}" class="btn btn-danger btn-xs btn-confirm-delete"><i class="fa fa-trash-o"></i></a>

                                                <a title="Move to Archive" href="{{ route('admin.blogs.move-to-archive', [$blog->id]) }}" class="btn btn-primary btn-xs btn-confirm-moveArchive"><i class="fa fa-archive"></i></a> 
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
