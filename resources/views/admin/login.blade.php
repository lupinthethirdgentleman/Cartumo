...
<body class="login-body">
    <div class="container">
        ...
        <!-- Modal -->   
        <form id="frmForgotPassword" class="form-signin" action="{{ route('admin.forgot-password') }}" method="post">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                              ...
                              <input id="forgotPwdEmail" type="text" name="email" placeholder="Email" autocomplete="off" class="form-control placeholder-no-fix">
...
<!-- js placed at the end of the document so the pages load faster -->
    ...
    <script type="text/javascript">
        /*$('#frmForgotPassword').on('submit', function(e){
            ...
            $.ajax({
                type : 'post',
                url  : '{{ route("admin.ajax-validateForgotPassword") }}',
                data : {
                    'email'  : $('#forgotPwdEmail').val(),
                    '_token' : '{{ csrf_token() }}'
                },
                success : function(response){
                    if(response == '0')
                    {
                        var $new = $("<span id='forgotPwdEmailErr' class=''></span>"),
                        new2 = document.createElement("div"),
                        existingdiv1 = document.getElementById( "foo" );
                        // $('#forgotPwdEmail').after("<span id='forgotPwdEmailErr' class=''></span>");
                        $( "#forgotPwdEmail" ).first().after( $new, [ new2, existingdiv1 ] );
                    }
