                ...
                <aside class="profile-nav col-lg-3">
                    <section class="panel">
                        <div class="user-heading round">
                            ...
                            @else
                                <a href="javascript:void(0);">
                                    <img src="{{ asset($imgPath . '/100x90/' . Auth::User()->image) }}"/>
                                </a>
                            @endif
                        ...
                        <ul class="nav nav-pills nav-stacked">
                            <li class="{{ (Route::currentRouteName() == 'admin.profile.show') ? 'active' : '' }}">
                            ...
                            <li class="{{ (Route::currentRouteName() == 'admin.profile.edit') ? 'active' : '' }}">
                                <a href="{{ route('admin.profile.edit') }}"> <i class="fa fa-edit"></i> Edit profile</a>
                            </li>
                        </ul>
                    </section>
                </aside>
                <aside class="profile-info col-lg-9">
                    <section class="panel">
                        ...
                        <div class="panel-body bio-graph-info">
                            ...
                            ?>
                            <h1> Profile Info</h1>
                            <form class="form-horizontal" action="{{ route('admin.profile.edit') }}" method="post" enctype="multipart/form-data" role="form">
                                {{ csrf_field() }}
                                <!-- {{ method_field('PUT') }} -->
                                <div class="form-group">
                                    <label  class="col-lg-2 control-label">First Name</label>
                                    <div class="col-lg-6">
                                        <input type="text" name="first_name" value="{{ Auth::user()->first_name }}" class="form-control" id="f-name" placeholder=" ">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" name="last_name" value="{{ Auth::user()->last_name }}" class="form-control" id="l-name" placeholder=" ">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" name="email" value="{{ Auth::user()->email }}" class="form-control" id="email" placeholder=" ">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        ?>
                                        @if(empty(Auth::user()->image) || !file_exists($img_path . '/100x90/' . Auth::user()->image ))
                                        ...
                                        @else
                                            <img class="img-responsive" src="{{ asset($img_path . '/100x90/' . Auth::user()->image) }}" height="50px;" width="100px;">
                                        @endif
                                    </div>    
                                </div>
                    ...
                    <section>
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal" role="form" method="post" action="{{ route('admin.profile.change.password') }}">
                                    {{ csrf_field() }}
                                    <div class="form-group">
