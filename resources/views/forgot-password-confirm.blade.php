					...
					<div class="row">
						<div class="col-md-offset-3 col-md-6 col-sm-offset-2 col-sm-8 col-xs-12">
							<div class="content-area">
								<form method="post" action="{{ route('reset-password') }}?email={{ $email }}&code={{ $code }}">
				    				...
				    				<div class="form-group col-md-12 col-sm-12 col-xs-12">
				    					<input type="password" name="confirmPassword" placeholder="Confirm Password" class="form-control txtfield" />
