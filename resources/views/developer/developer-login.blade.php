...
<head>
    ...
    <title>Cartumo Developer - Login</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <h2 class="text-center">CARTUMO DEVELOPER LOGIN</h2>
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Please Sign In</h3>
                    </div>
                    <div class="panel-body">
                        <form class="form-horizontal clearfix" method="POST" action="{{ route('developer.login.submit') }}">
                            {{ csrf_field() }}
