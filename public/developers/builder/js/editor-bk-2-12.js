...
$('#ex1').slider({
    ...
    $(document).on('mouseover', '.element', function(e) {
        ...
        if ( $(this).offset().top <= ($(".top_nav").offset().top + $(".top_nav").height() + 3) ) {
            ...
            $(this).find('.ld_controls').css({top: '-24px', bottom: 'initial'});
        }
...
$(document).on('click', '.open-order-two-step-settings', function(e) {
    ...
    $(document).on('click', '.open-empty-container-setings-modal', function(e) {
                ...
                $("input[name='empty_container_width']").prev().slider({value: $("input[name='empty_container_width']").val()});
    ...
    $(document).on('click', '.open-image-list-setings-modal', function(e) {
                ...
                $("input[name='image_list_text_size']").prev().slider({value: $("input[name='image_list_text_size']").val()});

                //Image Text Gap
                $("input[name='image_list_image_text_gap']").val($(option_open_for).find('.wrapper .image-list > li').prop('style')['padding-left'].split('px')[0]);
                $("input[name='image_list_image_text_gap']").prev().slider({value: $("input[name='image_list_image_text_gap']").val()});


                //Line height
                $("input[name='image_list_line_height']").val($(option_open_for).find('.wrapper .image-list > li').prop('style')['line-height'].split('px')[0]);
                $("input[name='image_list_line_height']").prev().slider({value: $("input[name='image_list_line_height']").val()});
                ...
                $("input[name='image_list_padding_top']").prev().slider({value: $("input[name='image_list_padding_top']").val()});
                $("input[name='image_list_padding_right']").val($(option_open_for).find('.wrapper').prop('style')['padding-right'].split('px')[0]);
                $("input[name='image_list_padding_right']").prev().slider({value: $("input[name='image_list_padding_right']").val()});
                $("input[name='image_list_padding_bottom']").val($(option_open_for).find('.wrapper').prop('style')['padding-bottom'].split('px')[0]);
                $("input[name='image_list_padding_bottom']").prev().slider({value: $("input[name='image_list_padding_bottom']").val()});
                $("input[name='image_list_padding_left']").val($(option_open_for).find('.wrapper').prop('style')['padding-left'].split('px')[0]);
                $("input[name='image_list_padding_left']").prev().slider({value: $("input[name='image_list_padding_left']").val()});

                //margin
                $("input[name='image_list_margin_top']").val($(option_open_for).find('.wrapper').prop('style')['margin-top'].split('px')[0]);
                $("input[name='image_list_margin_top']").prev().slider({value: $("input[name='image_list_margin_top']").val()});
                $("input[name='image_list_margin_right']").val($(option_open_for).find('.wrapper').prop('style')['margin-right'].split('px')[0]);
                $("input[name='image_list_margin_right']").prev().slider({value: $("input[name='image_list_margin_right']").val()});
                $("input[name='image_list_margin_bottom']").val($(option_open_for).find('.wrapper').prop('style')['margin-bottom'].split('px')[0]);
                $("input[name='image_list_margin_bottom']").prev().slider({value: $("input[name='image_list_margin_bottom']").val()});
                $("input[name='image_list_margin_left']").val($(option_open_for).find('.wrapper').prop('style')['margin-left'].split('px')[0]);
                $("input[name='image_list_margin_left']").prev().slider({value: $("input[name='image_list_margin_left']").val()});
    });
    ...
    $(document).on('click', '.open-paragraph-setings-modal', function(e) {
        ...
        try {
            ...
            $("input[name='paragraph_shadow_size']").prev().slider({value: $("input[name='paragraph_shadow_size']").val()});
        } catch (err) {}
    ...
    $(document).on('click', '.open-sub-headline-setings-modal', function(e) {
        ...
        $("input[name='sub_headline_line_height']").prev().slider({value: $("input[name='sub_headline_line_height']").val()});
        ...
        try {
            ...
            $("input[name='sub_headline_shadow_size']").prev().slider({value: $("input[name='sub_headline_shadow_size']").val()});
        } catch (err) {}
        ...
        $("#sub_headline_bg_color").val(rgb2hex($(option_open_for).find('.wrapper').prop('style')['backgroubd-color']));
    ...
    $(document).on('click', '.open-headline-setings-modal', function(e) {
        ...
        $("input[name='headline_shadow_size']").prev().slider({value: $("input[name='headline_shadow_size']").val()});
    });
    ...
    $(document).on('click', '.grid-one-setings-modal', function(e) {
        ...
        if ( $(option_open_for).css('background-color') )
            $("#grid_one_container_bg_color").val(rgb2hex($(option_open_for).prop('style')['background-color']));
    ...
    $(document).on('click', '.open-text-block-settings', function(e) {
        ...
        if ( $(option_open_for).find('.wrapper > b').attr('stye') != null )
            $("#textblock_headline_text_color").val(rgb2hex($(option_open_for).find('.wrapper > b').css('color')));

        if ( $(option_open_for).find('.wrapper > div').attr('stye') != null )
            $("#textblock_headline_bg_color").val(rgb2hex($(option_open_for).find('.wrapper > div').css('background-color')));
        ...
        $("input[name='text_block_line_height']").prev().slider({value: $("input[name='text_block_line_height']").val()});
    ...
    $(document).on('click', '#btn_save_product_description_setting', function(e) {
        ...
        //line height
        $(option_open_for).find('.wrapper p').css('line-height', json.product_description_line_height + 'px');
    ...
    $(document).on('click', '#text_block_setting_save', function(e) {
        ...
        //line-height
        $(option_open_for).find('.wrapper > div,.wrapper > p').css('line-height', json.text_block_line_height + 'px');
